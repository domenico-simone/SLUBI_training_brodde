...
**[config.yaml]**
- changing *reference* to new clustered file: pinus_clust_TEST_2.clstr
- changing *Data Folder* to: 200623_output

```bash
reference:
    /proj/mykopat-pineg/Hiplex_data/pinus_clust_ref.fasta
sample_pattern:
    "190522_deplex_norAga_Hiplex_tag_"

Raw_Folder:
    /proj/mykopat-pineg/Hiplex_data/hiplex_data
Data_Folder:
    /proj/mykopat-pineg/SLUBI_training_brodde/200623_output
clip_threshold:
    0.3
```
...
- running variant calling with new clustered reference:
